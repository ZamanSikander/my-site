        ...
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <MotionSection className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold sm:text-4xl">
              Recent builds and interface concepts.
            </h2>
          </MotionSection>
          <MotionSection delay={0.08}>
            <p className="max-w-md leading-7 text-ink/66 dark:text-paper/66">
              Migrated from the existing portfolio screenshots and copy, with
              room to replace placeholder links with live case studies.
            </p>
          </MotionSection>
        </div>
