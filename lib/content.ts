...
import type { Experience, Project, Service, SocialLink, Stat, Testimonial } from '@/types/content';
...
export const site = {
  ...
  email: 'zamansikander8577@gmail.com',
  phone: '+923046282698',
...
export const socialLinks: SocialLink[] = [
  { label: 'GitHub', href: 'https://github.com/zamansikander/', icon: Code2 },
  { label: 'LinkedIn', href: 'https://linkedin.com/in/zamansikander/', icon: ExternalLink },
  {
    label: 'Upwork',
...
export const coreStack = ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Supabase', 'Framer Motion'];

export const services: Service[] = [
  {
    title: 'Marketing Sites',
    description: 'Fast, polished landing pages and portfolio sites that make the offer clear on every screen.',
    icon: Rocket
  },
  {
    title: 'SaaS Products',
    description: 'Responsive front ends for dashboards, MVPs, onboarding flows, and product interfaces.',
    icon: Blocks
  },
  {
    title: 'Business Websites',
    description: 'Modern business sites, WordPress rebuilds, and service pages with clean UX and SEO fundamentals.',
    icon: Store
  },
  {
    title: 'Management Systems',
    description: 'Practical admin panels, internal tools, and data-heavy interfaces built for daily use.',
...
export const experiences: Experience[] = [
  {
    ...
    company: 'Freelance',
    description: 'Created and maintained WordPress websites, including custom themes and plugin work for clients.'
  },
  {
    role: 'Frontend Developer',
    company: 'Freelance',
    description: 'Built responsive and interactive web applications with React, Tailwind CSS, and modern tooling.'
  },
  {
    role: 'Web Designer',
    company: 'Freelance',
    description: 'Designed and developed responsive websites with HTML, CSS, and Bootstrap for small businesses.'
  },
  {
    role: 'MVP Developer',
    company: 'Freelance',
    description: 'Designed and developed a responsive MVP for a construction business using React and Tailwind CSS.'
  }
];
...
export const projects: Project[] = [
  {
    ...
    description: 'A personal portfolio site built with React and Tailwind CSS to present services and selected work.',
  ...
  },
  {
    ...
    description: 'A storefront concept with shopping cart flows, product presentation, and payment-oriented UX.',
  ...
  },
  {
    ...
    description: 'Analytics dashboard interface with KPIs, charts, and scan-friendly reporting layouts.',
  ...
  },
  {
    title: 'Landing Page',
    image: '/assets/portfolio-website.webp',
    description: 'A marketing page for a product or service, focused on crisp messaging and conversion paths.',
